...
export const Home: React.FC<HomeProps> = ({ onJoinRoom }) => {
  ...
  const handleCreateRoom = async () => {
    ...
    // Make sure accounts[0] exists and is a string
        ...
        <div className="bg-gray-900 p-6">
          ...
          {!isAuthenticated && (
            <div className="mb-2">
              ...
              <button
                className="w-full bg-green-600 hover:bg-green-700 text-white py-3 px-4 rounded-lg font-medium transition duration-200 flex items-center justify-center"
                disabled={isLoading}
                onClick={connect}
              >
            ...
            <div className="space-y-6">
              ...
              {!showRoomIdFromUrl && (
                <>
                  ...
                  <button
                    className="w-full bg-gray-700 hover:bg-gray-600 text-white py-3 px-4 rounded-lg font-medium transition duration-200"
          ...
          {isAuthenticated && showCreateForm && (
            <div className="space-y-4">
              ...
              <div className="flex space-x-3">
                <button
                  type="button"
                  className="flex-1 bg-gray-700 hover:bg-gray-600 text-white py-3 px-4 rounded-lg font-medium transition duration-200"
