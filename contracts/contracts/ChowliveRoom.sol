...
contract ChowliveRoom is LSP8Mintable {
     ...
     */
    function createRoom(bool isPublic, uint256 subscriptionFee)
        external
        payable
        returns (uint256)
    {
        ...
        userSubscriptions[msg.sender][roomId] =
            block.timestamp +
     ...
     */
    function hasAccess(address user, uint256 roomId)
        public
        view
        returns (bool)
    {
     ...
     */
    function getUserSubscribedRooms(address user)
        public
        view
